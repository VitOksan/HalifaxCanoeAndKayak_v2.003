...
<body>
	...
	<div class="container content_book">
		...
		<form class="form" action="thank-you.php" method="GET">
			<!-- *** Input form for First & Last Name *** ------------------------------->
				<!-- <label class="form_label" for="firstName">First Name</label>
				<input type="text" class="form_input" id="firstName" name="firstName" placeholder="Your First Name" required>
				<br>
				<label class="form_label" for="lastName">Last Name</label>
				<input type="text" class="form_input" id="lastName" name="lastName" placeholder="Your Last Name">
				<br> -->
			<br>
